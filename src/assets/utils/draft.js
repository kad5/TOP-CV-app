...
export function blankCV() {
  return {
    ...
    header: {
      ...
      customList1Title: "my list eg; skills",
      customList1Content: ["list item 1", "list item 2", "list item 3"],
      customList2Title: "my other list",
      customList2Content: [],
      customPara1Title: "my brief",
      customPara1Content: "Short summary of something I want to emphacise",
      customPara2Title: "Another brief",
